...
int main() {
    ...
    */
    ...
    auto add_Rykard = Raven_Session.add(kp_Hawk);                           // This generates a "proposal" that everyone needs to handle
    Raven_Session.handle(add_Rykard);                                       // Everyone handles the proposal
